...
def get_filters():
    ...
    while 1:
        choice = input(
            "Do you want to filter the data by month and/or week? Yes/No "
        ).lower()
        print()
...
def station_stats(df):
    ...
    print()
    print(
        "Most commonly used start station as per our data was {}".format(
    ...
    print()
    print(
        "Most commonly used end station as per our data was {}".format(
    ...
    print(
        "The most frequnt combination of start station and end station trip was {}".format(
...
def user_stats(df):
    ...
    if "Gender" not in df:
        ...
        print(
            "Number of genders of users mentioned in the data are {}".format(
                len(gender_of_users)
            )
        )
        for i in range(len(gender_of_users)):
            print(
                "{}s - {}".format(
                    gender_of_users["Gender"][i], gender_of_users["Start Time"][i]
                )
            )
        print(
            "Gender data for {} users is not available.".format(
                len(df)
                - gender_of_users["Start Time"][0]
    ...
    if "Birth Year" not in df:
        ...
        print(
            "Most recent year of birth was {}.".format(int(birth["Birth Year"].max()))
        )
        print(
            "Most common year of birth year was {}.".format(
